      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            />
            <Link
              href={`/businesses/${businessId}/payments/new`}
            ...
            {isLoading ? (
              ...
              <div className="p-4">
                <EmptyState
                  ...
                  action={
                    <Link href={`/businesses/${businessId}/payments/new`} className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm rounded-xl transition-all">
                      <Plus className="w-4 h-4" /> Record Payment
                    </Link>
                  }
                />
