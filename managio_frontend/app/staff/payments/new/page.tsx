...
import { useMembers, useMemberSubscriptions } from '@/lib/hooks/useMembers'
...
export default function StaffRecordPaymentPage() {
  ...
  return (
    <div className="max-w-xl mx-auto">
      <div className="mb-8">
        <Link href="/staff/payments" className="inline-flex items-center gap-2 text-sm text-white/50 hover:text-white/80 transition-colors mb-4">
