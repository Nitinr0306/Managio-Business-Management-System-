...
public class BusinessStatisticsResponse {
    ...
    // FIX 18: overview page references stats?.totalStaff for the Staff quick-link badge.
    // This field was missing from the DTO so the badge always rendered undefined.
